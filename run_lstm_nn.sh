...
while [ $i -lt 10 ]; do
    ...
    python $sent_dir/test_sent.py --aspects 12 --domain rest --cross-val-index $i \
        --model $model_dir/rest.lstm_nn.lstm_units_512_layers_2.mlp_units_512_layers_2_relu.lr1.0e-04.dropout0.3.$i.json \
        --weights $model_dir/rest.lstm_nn.lstm_units_512_layers_2.mlp_units_512_layers_2_relu.lr1.0e-04.dropout0.3.${i}_best.hdf5 \
...
while [ $i -lt 10 ]; do
    ...
    python $sent_dir/test_sent.py --aspects 81 --domain lapt --cross-val-index $i \
        --model $model_dir/lapt.lstm_nn.lstm_units_512_layers_2.mlp_units_512_layers_2_relu.lr1.0e-04.dropout0.3.$i.json \
        --weights $model_dir/lapt.lstm_nn.lstm_units_512_layers_2.mlp_units_512_layers_2_relu.lr1.0e-04.dropout0.3.${i}_best.hdf5 \
