...
if __name__ == '__main__':
    ...
    build_vocab([os.path.join(base_dir, 'train/sents.txt'), os.path.join(base_dir, 'test/sents.txt')], os.path.join(base_dir, 'vocab.txt'))
    build_vocab([os.path.join(base_dir, 'train/sents.txt'), os.path.join(base_dir, 'test/sents.txt')], os.path.join(base_dir, 'vocab-cased.txt'), lowercase=False)
