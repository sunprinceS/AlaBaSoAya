...
i=0
while [ $i -lt 10 ]; do
    python $sent_dir/train_sent.py --aspects 12 --domain rest --cross-val-index $i 2>> $log/rest_best_accs.log
...
i=0
while [ $i -lt 10 ]; do
    python $sent_dir/train_sent.py --aspects 81 --domain lapt --cross-val-index $i 2>> $log/lapt_best_accs.log
